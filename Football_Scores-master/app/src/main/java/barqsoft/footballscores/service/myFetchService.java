    ...
    private void getLeagues() {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                data.put(DatabaseContract.leagues_table._ID, leagueId);
                data.put(DatabaseContract.leagues_table.CAPTION_COL, caption);
                this.getContentResolver().insert(DatabaseContract.leagues_table.buildLeague(),
                        data);
            }
